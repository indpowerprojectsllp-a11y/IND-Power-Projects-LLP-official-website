...
const Home = () => {
  const values = valueCards.map((item, index) => ({ ...item, Icon: iconMap[index] || Check }));
  ...
  return (
    <Fragment>
      ...
      <main className="content-wrapper overflow-x-hidden">
        ...
        <section id="about" className="wrapper bg-light angled lower-end" aria-labelledby="about-heading">
          <div className="container py-12 py-md-13">
            <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
              <div className="col-lg-6">
                <Settings className="icon-svg-md mb-4 text-primary" aria-hidden="true" focusable="false" />
          ...
          <div className="container py-12 py-md-14">
            <div className="row text-center mb-8">
              <div className="col-lg-9 mx-auto">
                ...
                <h2 className="display-5 mb-3">Renewable-energy aligned industrial and advisory services</h2>
              ...
              {serviceCards.map(({ id, title, text, icon }) => (
                <div className="col-md-6 col-lg-4 d-flex" key={id}>
                  <div className="service-card w-100">
                    <div className="service-icon"><i className={`${icon} fs-34`} /></div>
          ...
          <div className="container py-12 py-md-13">
            <div className="row align-items-center gy-6">
              <div className="col-lg-7">
                ...
                <h2 className="display-5 mb-3">Consultancy for carefully evaluated property opportunities</h2>
                <p>
              ...
              <div className="col-lg-5">
                <div className="property-panel">
                  ...
                  <ul className="list-unstyled mb-0">
                    <li><i className="uil uil-check-circle" /> Bank auction properties</li>
                    <li><i className="uil uil-check-circle" /> DRT / SARFAESI matters</li>
                    <li><i className="uil uil-check-circle" /> NCLT / court-related property review</li>
                    <li><i className="uil uil-check-circle" /> Risk and value assessment support</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="container py-12 py-md-14">
            <div className="row text-center mb-8">
              <div className="col-lg-8 mx-auto">
                ...
                <h2 className="display-5 mb-0">Premium presentation with honest, grounded execution values</h2>
              </div>
            </div>
            <Facts arr={values} />
          </div>
          ...
          <div className="container py-12 py-md-14">
            <div className="row gy-8 align-items-center">
              <div className="col-lg-6">
                ...
                <h2 className="display-5 mb-3">Let’s discuss your renewable energy, electrical or consultancy requirement.</h2>
                <p className="lead mb-4">{company.address}</p>
                <p className="mb-2"><strong>Phone:</strong> {company.phonePrimary} / {company.phoneSecondary}</p>
                <p className="mb-0"><strong>Email:</strong> <a href={`mailto:${company.email}`}>{company.email}</a></p>
              </div>
              <div className="col-lg-6">
